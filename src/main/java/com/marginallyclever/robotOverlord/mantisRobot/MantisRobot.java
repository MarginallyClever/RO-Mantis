...
extends Robot {
	...
	protected void loadModels(GL2 gl2) {
		try {
			anchor = ModelFactory.createModelFromFilename("/src/main/resources/model/rotBaseCase.stl",0.1f);
			shoulder = ModelFactory.createModelFromFilename("/src/main/resources/model/Shoulder_r1.stl",0.1f);
			boom = ModelFactory.createModelFromFilename("/src/main/resources/model/Elbow.stl",0.1f);
			stick = ModelFactory.createModelFromFilename("/src/main/resources/model/Forearm.stl",0.1f);
			wrist = ModelFactory.createModelFromFilename("/src/main/resources/model/Wrist_r1.stl",0.1f);
			hand = ModelFactory.createModelFromFilename("/src/main/resources/model/WristRot.stl",0.1f);
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
